...
onMAinfo <- function(){
    ...
    catlginfo2 <- ttklabel(info.window,text="Designs in 64 runs are available for up to 32 factors (resolution IV).")
    tkgrid(catlginfo)
    tkgrid(catlginfo2)
...
onMaxC2info <- function(){
    ...
    tkgrid(tc)
    catlginfo <- ttklabel(info.window,text=gettextRcmdr("Cell entries for resolution III and IV designs:"))
